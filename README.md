...
Due to strict regulations regarding access to and processing of personal data, microdata cannot be uploaded to journal servers. However, we ensure data availability in accordance with requirements by allowing access to researchers who wish to replicate our analyses. All programs and necessary documentation can be uploaded to your server. 
