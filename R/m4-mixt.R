...
#' @export
m4.mixt.estimate.reclassify <- function(sim,maxiter=20,split_movers=FALSE,ncore=15,est_rep=45,est_nbest=10) {
  ...
  ctrl      = em.control(nplot=5000,tol=1e-7,dprior=1.001,fixb=TRUE,
                         sd_floor=1e-7,posterior_reg=1e-8,maxiter=2000,
                         est_rep=est_rep,est_nbest=est_nbest,sdata_subsample=0.1,sdata_subredraw=TRUE)
  if (ncore>1) {
